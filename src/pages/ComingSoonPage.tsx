            ...
            <Result
                ...
                subTitle={
                    <span className='text-slate-500'>
                        Module này hiện chưa hoàn thiện. Đội ngũ kỹ thuật của chúng tôi đang nỗ lực cập nhật trong thời
                        gian sớm nhất!
                    </span>
                }
                extra={
                    <Button
                        type='primary'
                        onClick={() => navigate('/')}
                        className='bg-blue-600 px-6 font-medium hover:bg-blue-700'
                    >
                        Quay lại Trang Chủ
                    </Button>
                }
