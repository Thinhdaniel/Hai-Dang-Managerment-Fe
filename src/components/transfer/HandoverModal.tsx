...
const HandoverModal = ({ open, assetName, submitting, onClose, onSubmit }: Props) => {
    ...
    const handleFileSelect = async (file: File) => {
        ...
        try {
            ...
            setImages((prev) => prev.map((i) => (i.uid === uid ? { ...i, cloudUrl, uploading: false } : i)));
        } catch {
            setImages((prev) => prev.map((i) => (i.uid === uid ? { ...i, uploading: false, error: true } : i)));
        ...
        >
            ...
            {assetName && (
                <div className='mb-5 rounded-xl border border-slate-100 bg-slate-50 px-4 py-3'>
                    <span className='text-xs font-semibold tracking-wider text-slate-400 uppercase'>Thiết bị</span>
            ...
            >
                ...
                <Form.Item
                    label={
                        <span className='font-medium text-slate-700'>
                            Người nhận bàn giao <span className='text-rose-500'>*</span>
                        </span>
                    }
                    name='receivedBy'
                ...
                >
                    <Input
                        ...
                        prefix={<span className='mr-1 text-slate-300'>👤</span>}
                    />
                </Form.Item>
                ...
                <div>
                    <div className='mb-2 font-medium text-slate-700'>
                        ...
                        <span className='ml-1.5 text-xs font-normal text-slate-400'>
                            (tùy chọn, tối đa {MAX_IMAGES} ảnh)
                        </span>
                    </div>
