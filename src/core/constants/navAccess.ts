...
import { can, isAdmin, isDirector, isProductionOperator } from '../lib/permissions';
...
const requireProductionHistory: AccessCheck = (user) =>
    can(user?.role, 'production.view') && !isProductionOperator(user?.role);
...
export const ROUTE_ACCESS: Record<string, AccessCheck> = {
    ...
    '/borrowings/outbound/new': requireCap('borrowing.write'),
    '/borrowings/outbound/:id': requireCap('borrowing.write'),
    ...
    '/production/orders': requireCap('production.manage'),
    '/production/master-plan': requireCap('production.manage'),
    '/production/materials': requireCap('production.manage'),
    '/production/capacity': requireCap('production.manage'),
    '/production/control-tower': requireCap('production.manage'),
    '/production/pilot': requireCap('production.manage'),
    '/production/rollout': requireDirectorUp,
